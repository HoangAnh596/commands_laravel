...
class NotifyListAssessorCompletingForm extends Command
{
    use NotifyTrait;
     ...
     * @var string
     */
    protected $signature = 'notify:assessor-completing';
     ...
     * @var string
     */
    protected $description = 'Notify list assessor completing form to manager';
    ...
    {
        $this->notify(Common::LIST_ASSESSOR_COMPLETING_FORM);
    }
}
