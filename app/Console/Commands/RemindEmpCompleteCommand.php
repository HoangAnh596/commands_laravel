...
class RemindEmpCompleteCommand extends Command
{
    use ReminderTrait;
     ...
     * @var string
     */
    protected $signature = 'remind:emp-complete';
     ...
     * @var string
     */
    protected $description = 'Remind employee complete their checkpoint form';
    ...
    {
        $this->remind(Common::REMIND_EMP_COMPLETE);
    }
}
