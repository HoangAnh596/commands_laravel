...
class RemindManagerAssignCommand extends Command
{
    use ReminderTrait;
     ...
     * @var string
     */
    protected $signature = 'remind:manager-assign';
     ...
     * @var string
     */
    protected $description = 'Remind manager assign an assessor to employee';
    ...
    {
        $this->remind(Common::REMIND_MANAGER_ASSIGN);
    }
}
